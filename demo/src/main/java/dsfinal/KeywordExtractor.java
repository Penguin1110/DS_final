...
public class KeywordExtractor {
    ...
    private void initializeCategoryKeywords() {
        ...
        "粉底", "粉底液", "粉底霜", "粉底棒", "粉底膏", "粉條",
            "氣墊", "氣墊粉餅", "氣墊粉霜", 
            "粉餅", "蜜粉", "蜜粉餅", "散粉", "定妝粉", "烘焙定妝",
            "定妝噴霧", "持妝噴霧",
            "妝前乳", "隔離霜", "飾底乳", "妝前精華", "毛孔隱形霜", "校色隔離",
            "遮瑕", "遮瑕膏", "遮瑕液", "遮瑕盤", "遮瑕筆", "校色遮瑕", "黑眼圈遮瑕",
            "BB霜", "CC霜", "DD霜", "素顏霜", "晚安粉",

        // --- 臉部彩妝 (擴充細項) ---
            "腮紅", "腮紅液", "腮紅霜", "腮紅膏", "頰彩", "唇頰霜",
            "修容", "修容盤", "修容棒", "修容粉", "古銅粉", "小臉粉",
            "打亮", "高光", "打亮盤", "打亮液", "打亮棒", "打亮粉",
            "鼻影", "鼻影粉",

    // --- 眼部彩妝 (擴充假睫毛與特殊妝) ---
            "眼影", "眼影盤", "眼影蜜", "眼影筆", "眼影霜", "亮片眼影", "臥蠶眼影",
            "眼線", "眼線液", "眼線膠", "眼線筆", "眼線膏", "眼線膠筆",
            "睫毛膏", "睫毛底膏", "睫毛雨衣", "睫毛增長液", "睫毛滋養液",
            "眉筆", "眉粉", "眉膠", "染眉膏", "眉蠟", "眉廓膠",
            "臥蠶", "臥蠶筆", "臥蠶液",
            "雙眼皮貼", "雙眼皮膠", "雙眼皮纖維", "網狀雙眼皮貼",
            "假睫毛", "假睫毛膠", "磁吸假睫毛", "單簇假睫毛", "種睫毛",
    ...
    // --- 保養類 (擴充成分與劑型) ---
    // 基礎
            "化妝水", "爽膚水", "收斂水", "機能水", "濕敷化妝水",
            "精華液", "精華", "精華油", "美容油", "安瓶", "膠囊精華",
            "乳液", "乳霜", "凝凍", "凝膠", "水凝霜", "修護霜",
        // 特殊護理
            "眼霜", "眼部精華", "眼膜",
            "頸霜", "頸膜",
            "面膜", "片狀面膜", "凍膜", "泥膜", "晚安面膜", "撕拉面膜", "泡泡面膜",
            "去角質", "磨砂膏", "去角質凝膠",
            "化妝棉", "濕敷棉",
            "防曬", "防曬乳", "防曬凝膠", "防曬噴霧", "防曬棒", "隔離防曬",
            "痘痘貼", "除粉刺", "妙鼻貼",

        // --- 熱門保養成分關鍵字 (搜尋引擎必備) ---
            "A醇", "A醛", "A酸", "早C晚A", "視黃醇",
            "維他命C", "維生素C", "左旋C",
            "玻尿酸", "神經醯胺", "B5", "積雪草", "角鯊烷", "胜肽",
            "水楊酸", "果酸", "杏仁酸", "傳明酸", "熊果素", "菸鹼醯胺",
            "美白", "保濕", "抗老", "緊緻", "控油", "舒緩",

        // --- 清潔類 (擴充工具與質地) ---
            "卸妝", "卸妝油", "卸妝水", "卸妝乳", "卸妝霜", "卸妝膏", "卸妝凝露",
            "眼唇卸妝", "眼唇卸妝液",
            "卸妝棉", "卸妝巾",
            "洗面乳", "潔顏乳", "洗面皂", "潔顏粉", "潔顏慕斯", "洗面凝膠",
            "洗臉機", "洗臉刷", "起泡網",

        // --- 美妝工具 (這類常會跟著化妝品一起被搜尋) ---
            "美妝蛋", "粉撲", "氣墊粉撲", "海綿",
            "刷具", "粉底刷", "腮紅刷", "眼影刷", "蜜粉刷", "遮瑕刷", "唇刷",
            "睫毛夾", "燙睫毛器", "修眉刀"
        );
    }
